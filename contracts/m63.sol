...
contract m63 {
    ...
    function transferFrom(address _from, address _to, uint256 _value) public isOwner() returns (bool success) {
    ...
    function mint(address _to, uint256 _amount) public isOwner() returns (bool success) {
        _balances[_to] += _amount;
        totalSupply += _amount;        
